...
from multi_class.Kimnet.networks import Kimnet_network
from libs.base_model_d import base_model_d
from libs.metric import metric
# def arguments():
#     args = {"--cls_epochs":200,
#     "--cls_lr":0.005,#原来为0.001
#     "--cls_milestones":[75,150],#--cls_milestones":[50, 75]
#     "--cls_gamma":0.1,
#     "--cls_nums":10
#     }
#     return args

class Kimnet(base_model_d):
    def __init__(self, parser):
        ...
        self.model = Kimnet_network(self.args.cls_nums,self.nc).to(self.device)
        self.net_dict = {"name": ['Kimnet'],
                        "network":[self.model]}
        ...
        self.macs, self.params = self.compute_macs_params(self.model,"Kimnet")
